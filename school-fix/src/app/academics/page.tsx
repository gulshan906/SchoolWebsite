    ...
    <main className="min-h-screen bg-slate-50 text-slate-900">
      ...
      <header className="sticky top-0 z-50 border-b border-slate-200 bg-white shadow-sm">
        <div className="mx-auto flex max-w-7xl items-center justify-between px-4 py-3 sm:px-6 lg:px-8">
          <Link href="/" className="flex items-center gap-3">
            ...
            <div>
              <p className="text-sm font-black sm:text-base">Shiv Gurukul</p>
      ...
      <section className="bg-gradient-to-br from-slate-950 via-blue-950 to-blue-800 px-4 py-16 text-white sm:px-6 lg:px-8 lg:py-24">
        <div className="mx-auto max-w-7xl">
          ...
          <h1 className="mt-3 max-w-4xl text-4xl font-black leading-tight sm:text-5xl lg:text-6xl">
            ...
            <span className="block text-blue-300">Bright Future.</span>
          </h1>
        ...
        <div className="mx-auto max-w-7xl">
          <div className="grid gap-5 sm:grid-cols-2 lg:grid-cols-4">
            <div className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
              ...
              <h2 className="mt-2 text-2xl font-black">Class 1 - 10</h2>
            </div>
            ...
            <div className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
              ...
              <h2 className="mt-2 text-2xl font-black">CBSE</h2>
            </div>
            ...
            <div className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
              ...
              <h2 className="mt-2 text-2xl font-black">English</h2>
            </div>

            <div className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
              <div className="text-3xl font-black text-blue-700">04</div>
              <p className="mt-5 text-xs font-black uppercase tracking-wider text-slate-400">
                School Type
              </p>
              <h2 className="mt-2 text-lg font-black">Co-Educational</h2>
              <p className="mt-1 text-sm text-slate-500">English Medium School</p>
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="mx-auto max-w-7xl">
          <div className="max-w-3xl">
            ...
            <h2 className="mt-3 text-3xl font-black sm:text-4xl">
              Learning That Goes
              <span className="text-blue-700"> Beyond Textbooks.</span>
            </h2>
      ...
      <section className="px-4 py-16 sm:px-6 lg:px-8 lg:py-20">
        <div className="mx-auto max-w-5xl rounded-[2rem] bg-slate-950 p-8 text-white sm:p-12">
          ...
          <h2 className="mt-3 text-3xl font-black sm:text-4xl">CBSE Curriculum</h2>
          ...
          <div className="mt-8 grid gap-4 sm:grid-cols-2">
            ...
            <div className="rounded-2xl border border-white/10 bg-white/5 p-5">
              <p className="font-black">Communication Skills</p>
              <p className="mt-2 text-sm text-slate-400">
      ...
      <footer className="bg-white px-4 py-8 text-center">
        <p className="text-sm font-black">Shiv Gurukul Public School</p>
