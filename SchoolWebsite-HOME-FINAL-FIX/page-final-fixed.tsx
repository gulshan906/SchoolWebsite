  ...
  return (
    <main className="min-h-screen bg-white text-slate-900">
      ...
      <div className="bg-slate-950 px-4 py-2 text-center text-xs font-bold text-white">
         Welcome to Shiv Gurukul Public School &bull; Established 2015
      </div>
        ...
        <div className="border-t-4 border-blue-700 pt-5">
          ...
          <div className="mt-8 grid gap-10 lg:grid-cols-2">
            ...
            <div className="space-y-5 text-sm leading-7 text-slate-600 sm:text-base">
              ...
              <p>
                For us, education is not only about achieving good marks&mdash;it
              ...
              <div className="flex aspect-square items-center justify-center rounded-3xl bg-blue-50 p-5 text-center">
                ...
                <div>
                  ...
                  <p className="mt-1 text-xs text-slate-500">
                    Knowledge &bull; Values &bull; Confidence
                  </p>
                </div>
            ...
            <div className="flex flex-col items-center gap-5 text-center sm:flex-row sm:text-left">
              ...
              <div>
                ...
                <p className="mt-2 text-sm leading-6 text-slate-300">
                  Classes 1&ndash;10 | CBSE Curriculum | English Medium |
        ...
        <div className="mx-auto max-w-7xl">
          ...
          <div className="mt-8 grid gap-4 sm:grid-cols-2">
            ...
            <a
              ...
              className="group rounded-2xl border border-pink-400/20 bg-white/5 p-5 transition hover:-translate-y-1 hover:bg-pink-500/10"
            >
              <p className="text-[10px] font-black uppercase tracking-wider text-pink-300">
                Follow Us
              </p>
              <h3 className="mt-2 text-xl font-black">Instagram</h3>
              <p className="mt-2 text-sm leading-6 text-slate-400">
                Follow Shiv Gurukul Public School for school updates, events and campus moments.
              </p>
              <span className="mt-4 inline-flex rounded-full border border-pink-400/30 px-4 py-2 text-xs font-black text-pink-300 transition group-hover:bg-pink-500 group-hover:text-white">
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="group rounded-2xl border border-red-400/20 bg-white/5 p-5 transition hover:-translate-y-1 hover:bg-red-500/10"
            >
              <p className="text-[10px] font-black uppercase tracking-wider text-red-300">
                Watch Us
              </p>
              <h3 className="mt-2 text-xl font-black">YouTube</h3>
              <p className="mt-2 text-sm leading-6 text-slate-400">
                Watch school videos, events and memorable moments on our YouTube channel.
              </p>
              <span className="mt-4 inline-flex rounded-full border border-red-400/30 px-4 py-2 text-xs font-black text-red-300 transition group-hover:bg-red-500 group-hover:text-white">
                Visit YouTube &rarr;
              </span>
            </a>
